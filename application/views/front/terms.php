      ...
      <section class="terms check-color" style="background-color: #9cd08e;" data-color="#9cd08e">
         <div class="container">
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  <div class="terms">
                     ...
                     <p><strong>Website</strong>refersto Gujaratniamirat , accessible from&nbsp;<a href="<?= base_url() ?>"><?= base_url() ?>//</a></p>
