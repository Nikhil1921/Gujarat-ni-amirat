...
class Nation extends MY_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->redirect = admin("nation");
	}

	private $name = 'nation';
    private $title = 'nation';
    private $table = "nation";
	...
	public function get()
    {
        $fetch_data = $this->main->make_datatables('nation_model');
        $sr = $_POST['start'] + 1;
        $data = array();
        ...
        $output = array(  
            ...
            "recordsFiltered"   => $this->main->get_filtered_data('nation_model'),
            "data"              => $data,
            $csrf_name          => $csrf_hash
        );
