...
class BioWorld extends MY_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->redirect = admin("bioWorld");
	}

	private $name = 'bioWorld';
    private $title = 'bio world';
    private $table = "bio_world";
	...
	public function get()
    {
        $fetch_data = $this->main->make_datatables('bio_world_model');
        $sr = $_POST['start'] + 1;
        $data = array();
        ...
        $output = array(  
            ...
            "recordsFiltered"   => $this->main->get_filtered_data('bio_world_model'),
            "data"              => $data,
            $csrf_name          => $csrf_hash
        );
